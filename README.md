...
```sh
# Linux and macOS: install to ~/.local/bin (or $ORIEL_INSTALL_DIR); pin with ORIEL_VERSION=v0.6.7.
...
oriel update --version v0.6.7 # Update or downgrade to a specific release tag
```
