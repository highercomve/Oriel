...
const desktop_entry_cmd = @import("desktop_entry.zig");
...
test "command table" {
    ...
    for ([_][]const u8{ "init", "doctor", "setup", "update", "webview2", "deep-link", "permission", "signing", "desktop-entry", "zig", "dev", "build", "run", "package", "types", "check" }) |name| {
