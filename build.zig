...
const Features = struct {
    ...
    fn fromOptions(b: *std.Build, target: std.Build.ResolvedTarget) Features {
        ...
        inline for (@typeInfo(Features).@"struct".fields) |field| {
            ...
            // deep_link is opt-in (default off) like the others.
            const default_on = !is_native and !is_deep_link and !(is_macos and (unported or std.mem.eql(u8, field.name, "tray")));
